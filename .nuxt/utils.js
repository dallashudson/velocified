...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"CTF_SPACE_ID":"cum6u25svmrl","CTF_CDA_ACCESS_TOKEN":"SkR_GQCejufjpdlaOvW-UzAEjk6Dl-7xjIq6UEymcy4","CTF_PERSON_ID":"15jwOBqpxqSAOy2eOO4S0m","CTF_BLOG_POST_TYPE_ID":"blogPost"}
    }
    // Only set once
